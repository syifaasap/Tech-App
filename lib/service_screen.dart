...
class _NewServiceSreenState extends State<NewServiceSreen> {
  ...
  Color? buttonColors = const Color.fromARGB(255, 56, 120, 240);
  ...
  saveAssignTechnicianDetailsToUserServiceRequest() {
    ...
    databaseReference.child("vehicle_details").set(
        "${onlineTechnicianData!.vehicle_color} ${onlineTechnicianData!.vehicle_model}${onlineTechnicianData!.vehicle_number}");
  }
